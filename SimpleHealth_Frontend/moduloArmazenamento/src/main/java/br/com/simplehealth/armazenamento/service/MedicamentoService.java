...
/**
 * Serviço para consumir APIs relacionadas a medicamentos.
 * 
 * @version 1.0
 */
public class MedicamentoService {
    ...
    private static final String BASE_URL = AppConfig.MEDICAMENTOS_API_URL;
     ...
     */
    public List<Medicamento> buscarTodos() throws IOException {
        ...
        try (CloseableHttpClient client = HttpClients.createDefault()) {
            return client.execute(request, response -> {
                ...
                return objectMapper.readValue(jsonResponse, new TypeReference<List<Medicamento>>() {});
            });
        }
    }
     ...
     */
    public Medicamento criar(Medicamento medicamento) throws IOException {
